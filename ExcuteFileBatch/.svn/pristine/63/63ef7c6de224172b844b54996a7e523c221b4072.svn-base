...
namespace DemoFluentValidation {
    public partial class FormTongHop5BaoCao : Form {
        #region Variable
        ...
        private void LoadFakeData() {
            ...
            g_table.Rows.Add(new object[] { "VI", "Tài sản cố định trang bị cho đơn vị", "30", 3319371588, 3319371588, "     30 = 31 + 35" });
        ...
        public void CreateListRule() {
            ...
            //    g_listRule.Add(new RuleTable($"A.10.{item}", OPERATOR.EQUAL, $"A.11.{item} + A.12.{item} + A.14.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.20.{item}", OPERATOR.GREAT_THAN_OR_EQUAL, 0, g_table));

            //    g_listRule.Add(new RuleTable($"A.30.{item}", OPERATOR.EQUAL, $"A.31.{item} + A.35.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.31.{item}", OPERATOR.EQUAL, $"A.32.{item} + A.33.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.33.{item}", OPERATOR.LESS_THAN_OR_EQUAL, 0, g_table));

            //    g_listRule.Add(new RuleTable($"A.35.{item}", OPERATOR.EQUAL, $"A.36.{item} + A.37.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.37.{item}", OPERATOR.LESS_THAN_OR_EQUAL, 0, g_table));

            //    g_listRule.Add(new RuleTable($"A.50.{item}", OPERATOR.EQUAL, $"A.80.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.50.{item}", OPERATOR.EQUAL, $"A.01.{item} + A.05.{item} + A.01.{item} + A.10.{item} + A.20.{item} + A.25.{item} + A.30.{item} + A.40.{item} + A.45.{item} + A.46.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.60.{item}", OPERATOR.EQUAL, $"A.61.{item} + A.62.{item} + A.64.{item} + A.65.{item} + A.66.{item} + A.67.{item} + A.68.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.70.{item}", OPERATOR.EQUAL, $"A.71.{item} + A.72.{item} + A.73.{item} + A.74.{item} + A.75.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.80.{item}", OPERATOR.EQUAL, $"A.50.{item}", g_table));

            //    g_listRule.Add(new RuleTable($"A.80.{item}", OPERATOR.EQUAL, $"A.60.{item} + A.70.{item}", g_table));
